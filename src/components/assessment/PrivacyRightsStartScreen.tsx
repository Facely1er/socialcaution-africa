...
interface PrivacyRightsStartScreenProps {
  onStart: () => void;
}

const PrivacyRightsStartScreen: React.FC<PrivacyRightsStartScreenProps> = ({ onStart }) => {
  ...
  const features = [
    {
      ...
      description: 'Evaluate your understanding and exercise of privacy rights',
      icon: <FileCheck className="h-6 w-6 text-blue-600" />
    },
    {
      title: 'Compliance Check',
      description: 'Check your compliance level with regulations',
      icon: <Shield className="h-6 w-6 text-green-600" />
    },
    {
      title: 'Improvement Plan',
      description: 'Get recommendations to strengthen your rights',
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm p-8">
      <motion.div
        ...
        className="mb-8"
      >
        <FileCheck className="h-16 w-16 text-accent mx-auto" />
      </motion.div>
