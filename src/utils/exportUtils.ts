...
import { AssessmentResults, UserLevel } from '../types/assessment';
...
export const exportToPDF = (data: ExportableData): void => {
  const doc = new jsPDF();
...
export const exportToCSV = (data: ExportableData): void => {
  let csvContent = '';
...
export const exportToJSON = (data: ExportableData): void => {
  const jsonData = {
    ...data,
