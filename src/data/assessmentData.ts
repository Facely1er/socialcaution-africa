...
export const questions: Question[] = [
  ...
  },
  {
    ...
    text: 'How does your employer monitor your work activities?',
    ...
    options: [
      {
        text: 'I don\'t know if my employer monitors my activities',
        value: 'unknown',
        score: 0,
        level: 'beginner'
      },
      {
        text: 'I believe they monitor basic computer usage only',
        value: 'basic-monitoring',
        score: 1,
        level: 'beginner'
      },
      {
        text: 'I know they monitor computer activity and internet usage',
        value: 'computer-internet',
        score: 2,
        level: 'intermediate'
      },
      {
        text: 'I\'m aware of comprehensive monitoring including keystrokes, emails, and location',
        value: 'comprehensive',
        score: 3,
        level: 'advanced'
      }
    ...
    standards: [
      {
        name: 'GDPR',
        description: 'Employee Data Protection and Monitoring Transparency'
      }
    ]
  },
  {
    id: 'personal-device-usage',
    text: 'How do you handle personal activities on work devices?',
    category: 'Workplace Privacy',
    importance: 'high',
    criticality: 4,
    complexity: 2,
    ...
    options: [
      {
        text: 'I use work devices for all personal activities including social media and banking',
        value: 'all-personal',
        score: 0,
        level: 'beginner'
      },
      {
        text: 'I occasionally use work devices for personal activities',
        value: 'occasional-personal',
        score: 1,
        level: 'beginner'
      },
      {
        text: 'I limit personal use to non-sensitive activities only',
        value: 'limited-personal',
        score: 2,
        level: 'intermediate'
      },
      {
        text: 'I use personal devices for all personal activities and keep work devices separate',
    ...
    standards: [
      {
        name: 'ISO 27001',
        description: 'Information Security Management - Device Usage Policies'
      }
    ]
  },
  {
    id: 'data-access-rights',
    text: 'How familiar are you with your rights regarding personal data at work?',
    category: 'Workplace Privacy',
    importance: 'high',
    criticality: 4,
    complexity: 2,
    ...
    options: [
      {
        text: 'I don\'t know what rights I have regarding my personal data',
        value: 'no-knowledge',
        score: 0,
        level: 'beginner'
      },
      {
        text: 'I have a basic understanding but haven\'t exercised any rights',
        value: 'basic-understanding',
        score: 1,
        level: 'beginner'
      },
      {
        text: 'I know my rights and have requested access to my data',
        value: 'know-and-requested',
        score: 2,
        level: 'intermediate'
      },
      {
        text: 'I actively exercise my data rights and stay informed about privacy laws',
        value: 'active-exercise',
        score: 3,
        level: 'advanced'
      }
    ],
    standards: [
      {
        name: 'GDPR',
        description: 'Data Subject Rights and Employee Data Protection'
      }
    ]
  },
  {
    id: 'workplace-surveillance',
    text: 'How aware are you of surveillance measures in your workplace?',
    category: 'Workplace Privacy',
    importance: 'medium',
    criticality: 3,
    complexity: 2,
    ...
    options: [
      {
        text: 'I\'m not aware of any surveillance measures',
        value: 'unaware',
        score: 0,
        level: 'beginner'
      },
      {
        text: 'I know there are security cameras but not much else',
        value: 'cameras-only',
        score: 1,
        level: 'beginner'
      },
      {
        text: 'I\'m aware of video surveillance and some digital monitoring',
        value: 'video-digital',
        score: 2,
        level: 'intermediate'
      },
      {
        text: 'I have a comprehensive understanding of all surveillance measures',
        value: 'comprehensive-awareness',
        score: 3,
        level: 'advanced'
      }
    ],
    standards: [
      {
        name: 'GDPR',
        description: 'Employee Privacy Rights and Surveillance Transparency'
      }
    ]
  },
  {
    id: 'data-sharing-consent',
    text: 'How do you handle requests for personal data sharing at work?',
    category: 'Workplace Privacy',
    importance: 'high',
    criticality: 4,
    complexity: 2,
    ...
    options: [
      {
        text: 'I provide personal data whenever requested without questioning',
        value: 'always-provide',
        score: 0,
        level: 'beginner'
      },
      {
        text: 'I sometimes ask why the data is needed before providing it',
        value: 'sometimes-question',
        score: 1,
        level: 'beginner'
      },
      {
        text: 'I regularly question data requests and understand the purpose',
        value: 'regularly-question',
        score: 2,
        level: 'intermediate'
      },
      {
        text: 'I carefully review all data sharing requests and only consent when necessary',
        value: 'careful-review',
        score: 3,
        level: 'advanced'
      }
    ...
    standards: [
      {
        name: 'GDPR',
        description: 'Consent and Lawful Basis for Data Processing'
      }
    ]
  }
];
...
export const actionPlans = {
  ...
  medium: {
    ...
    'workplace-privacy': {
      steps: [
        'Review your employment contract and company privacy policies',
        'Understand what personal data your employer collects and why',
        'Request access to your personal data under data protection laws',
        'Separate personal and work activities on different devices',
        'Be aware of monitoring and surveillance measures in your workplace',
        'Know your rights regarding data correction and deletion',
        'Use encrypted communication for sensitive personal matters',
        'Regularly review and update your privacy settings on work accounts'
      ],
      resources: [
        {
          title: 'GDPR Employee Rights Guide',
          url: 'https://gdpr.eu/employee-rights/'
        },
        {
          title: 'Workplace Privacy Rights - Electronic Frontier Foundation',
          url: 'https://www.eff.org/issues/workplace-privacy'
        },
        {
          title: 'Employee Data Protection - Privacy Rights Clearinghouse',
          url: 'https://privacyrights.org/consumer-guides/employee-data-protection'
        }
      ]
    }
  },
